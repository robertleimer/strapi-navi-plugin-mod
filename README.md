<div align="center" width="150px">
  <img style="width: 150px; height: auto;" src="public/assets/logo.png" alt="Logo - Simple Strapi Navigation plugin" />
</div>
<div align="center">
  <h1>Strapi v4 - Simple Navigation plugin</h1>
  <p>Create consumable navigation with a simple and straightforward visual builder</p>
  <p>No URL input field, free url creating in frontend based on "related" field</p>
  <p>No dropdown menus etc, just a simple navigation list build tool</p>
  <a href="https://www.npmjs.org/package/simple-strapi-navigation-plugin">
    <img alt="GitHub package.json version" src="https://img.shields.io/github/package-json/v/mrflynn/simple-strapi-navigation-plugin?label=npm&logo=npm">
  </a>
  <a href="https://www.npmjs.org/package/simple-strapi-navigation-plugin">
    <img src="https://img.shields.io/npm/dm/simple-strapi-navigation-plugin.svg" alt="Monthly download on NPM" />
  </a>
</div>
